...
\problempart Part b  % TODO: binary search with comparisons taking O(d) time!
\end{problemparts}

\problem  % Problem 2

\begin{problemparts}
\problempart Part a https://learning-modules.mit.edu/service/materials/groups/143172/files/fade9734-e5c0-4a2a-9688-61145254efbd/link?errorRedirect=%2Fmaterials%2Findex.html
